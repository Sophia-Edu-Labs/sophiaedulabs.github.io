...
const config = {
  ...
  tagline: 'Try the new Sophia App',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'http://sophia-edu-labs.github.io/',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'Youtube',
                href: 'https://youtube.com/@sophiaedulabs',
              },
              {
                label: 'Blog',
                to: '/blog',
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Sophia Edu Labs. Built with Docusaurus.`,
      },
      prism: {
